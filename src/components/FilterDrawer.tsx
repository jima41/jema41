      ...
      <div className="fixed right-0 top-0 h-screen w-full md:w-[350px] bg-background backdrop-blur-md border-l border-border/40 shadow-2xl z-50 flex flex-col">
        ...
        >
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            transition={{ type: 'spring', stiffness: 300, damping: 25 }}
            className="flex-1 h-9 border border-foreground/40 hover:border-foreground/70 text-foreground text-xs font-medium rounded transition-all"
          >
            Appliquer
          </motion.button>
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            transition={{ type: 'spring', stiffness: 300, damping: 25 }}
            className="flex-1 h-9 border border-border/20 hover:border-border/60 text-foreground/70 hover:text-foreground text-xs font-medium rounded transition-all"
          >
            Réinitialiser
          </motion.button>
        </motion.div>
