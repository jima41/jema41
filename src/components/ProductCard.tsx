...
const ProductCard = ({ 
  ...
  return (
    ...
    >
      {/* Image Container */}
      <motion.div 
        className="relative aspect-square overflow-hidden rounded-t-lg md:rounded-t-xl rounded-b-none bg-white/70 dark:bg-black/40 mb-2 md:mb-3"
      ...
      <div className="flex flex-col min-h-[110px] p-3 rounded-none bg-white/70 dark:bg-black/40 backdrop-blur-md transition-all duration-300 cursor-pointer">
        {/* Brand & Title */}
        <div className="mb-2">
