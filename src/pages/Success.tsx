      ...
      <main className="flex-1 py-20 md:py-32 flex items-center justify-center">
        <div className="container mx-auto max-w-2xl px-4">
          ...
          >
            {/* Success Icon */}
            <motion.div
              className="mb-12 inline-flex items-center justify-center w-24 h-24 rounded-full bg-gradient-to-r from-[#D4AF37]/20 to-[#FCEEAC]/20 border border-[#D4AF37]/40"
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              <motion.button
                onClick={() => navigate('/')}
                className="px-8 py-3 rounded-lg border border-border/40 hover:border-border/80 hover:bg-secondary/30 text-sm font-medium text-foreground transition-all"
              ...
              <motion.button
                ...
                className="px-8 py-3 rounded-lg border border-[#D4AF37]/60 bg-gradient-to-r from-[#D4AF37]/10 to-[#FCEEAC]/10 hover:border-[#D4AF37] hover:bg-gradient-to-r hover:from-[#D4AF37]/20 hover:to-[#FCEEAC]/20 text-sm font-medium text-foreground transition-all"
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
              >
